...
class StableLowerEnvCfg(ManipLocoEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Current-asset calibration: qdot signs that correspond to physical
        # forward rolling are FL/FR/RL/RR = (+,+,-,-).  Keep the legacy base
        # environment unchanged, but make this teacher's reward agree with
        # the executor and the measured wheel-center track.
