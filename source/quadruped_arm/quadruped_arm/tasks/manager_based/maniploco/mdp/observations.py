...
class VbcPolicyObsTerm(ManagerTermBase):
    ...
    def __init__(self, cfg, env):
        ...
        self.physical_action_dim = p.get("physical_action_dim", None)
        ...
        # Preserve the body-index convention used when ZYB-v0 was trained.
    ...
    def __call__(self,env,asset_name=None,obs_joint_names=None,contact_body_names=None,
                 history_len=None,use_priv=None,arm_base_offset=None,physical_action_dim=None):
        ...
        if self.physical_action_dim is not None:
            last_act = last_act[:, : int(self.physical_action_dim)]
